# Week 02 Summary (M1 Notebook-Only Reproducible Analysis)
...
- Week 1 notebook work can be rerun from a clean state.
...
- Weekly review and M2 prep notes are completed in the notebook.
